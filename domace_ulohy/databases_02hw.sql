...
-- získaj poèet pasaierov a celkovú prepravnú kapacitu
-- všetkıch spoloèností, ktoré vlastnia lietadlo
select Flights.Company, sum(Flights.Passengers) as TotalPassengers, min(Q1.TotalCapacity)
from Flights, (
